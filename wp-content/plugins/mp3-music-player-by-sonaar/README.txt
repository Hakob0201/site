...
The most advanced Audio Player. Support Elementor, Gutenburg & Shortcode. Add nice soundwave design, music & playlist to any posts and custom posts.

== Description ==

MP3 Music Player by Sonaar is a very easy Audio Player for WordPress. It gives you the ability to add unlimited numbers of playlists, albums and audio tracks to any post and custom posts using our Elementor Widget, Gutenburg or native shortcodes with tons of attributes. It's very flexible and easy to use.

You can display an optional jaw-dropping waveform bar under any of your audio player powered by WaveSurfer.js. Our MP3 Player is super easy to use, includes tons of features and the design and UX is very professional.

There is 3 easy ways to use the player. Upload your MP3 file from your page, post, custom post or directly in Elementor!

1) If you use Elementor, just add the MP3 Player Elementor Widget.
2) If you use Gutenburg, just add the MP3 player Gutenburg block.
3) Or you can use our custom shortcode anywhere!
...
No XML, JSON or FTP is required to use this HTML5 audio player! Just upload your MP3 or M4A tracks within WordPress and add the playlist anywhere on your site using Gutenburg, shortcode or by using Elementor! This free plugin will automatically fetch metadata from your files to autocomplete the album titles & track names.
...
* Embed audio players using our Gutenburg Block (NEW!)
...
* Continuous Audio Playback / Persistent Player (NEW)
...
4. To display the mp3 audioplayer on any of your page, add the MP3 Player Elementor Widget if you use Elementor, the MP3 player Gutenburg block if you use Gutenburg or insert the `[sonaar_audioplayer]` shortcode. To help you to generate the shortcode, simply click the small music icon. [see screensot](https://d.pr/i/BRsRBL). Make sure to select which album you want to use by selecting at least one album. 
